...
import InOutReportDaily from "@components/organisms/mgr/SEIKATSUKAIGO/report/InOutReportDaily";
...
const Report: React.FunctionComponent<Props> = (props: Props) => {
  const onChangeTag = (event: any, value: number) => {
    if (value === SEIKATSUKAIGOReportTabInfo.USERS) {
    ...
    <AdminTemplate pageName="利用実績">
      <>
        <KnowbeTabs
          ...
          selectedTab={SEIKATSUKAIGOReportTabInfo.DAILY}
          tabsStyle={{
            height: 35.5,
            position: "relative",
            zIndex: 10,
