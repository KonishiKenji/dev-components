...
import initialValues, {
  RecordDailyValues
} from "@initialize/mgr/SEIKATSUKAIGO/record/daily/initialValues";
import validation from "@initialize/mgr/SEIKATSUKAIGO/record/daily/validation";
import { AppState } from "@stores/type";
import { OperationsState } from "@stores/domain/operations/types";
import { WorkState } from "@stores/domain/work/types";
import { StaffState } from "@stores/domain/staff/types";
import { SEIKATSUKAIGOInOutReportState } from "@stores/domain/mgr/SEIKATSUKAIGO/report/types";
...
import DailyOperationDiary from "@components/organisms/mgr/SEIKATSUKAIGO/record/DailyOperationDiary";
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => {
  const { operationsDispatcher, pages, uiDispatch, SEIKATSUKAIGO } = dispatches;
  ...
  return {
    ...
    setEditing: (): { readonly type: "PAGES/RECORD/DAILY/SET_EDIT" } =>
      dispatch(recordDailyActions.setEdit()),
    unsetEditing: (): { readonly type: "PAGES/RECORD/DAILY/UNSET_EDIT" } =>
