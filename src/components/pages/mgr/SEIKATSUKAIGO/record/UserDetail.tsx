...
import UserInfoRecord from "@components/organisms/mgr/SEIKATSUKAIGO/record/UserInfoRecord";
import UserDetailRecord from "@components/organisms/mgr/SEIKATSUKAIGO/record/UserDetailRecord";
...
// 生活介護以外で呼ばれるようになったら直す
const mapStateToProps = (state: AppState): StateProps => ({
  facility: state.SEIKATSUKAIGO.facility,
  user: state.SEIKATSUKAIGO.userInFacility.user,
