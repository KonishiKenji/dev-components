...
import UsagePerformanceDailyList from "@components/organisms/mgr/SHISETSUNYUSHO/report/UsagePerformanceDailyList";
 ...
 * 利用実績
 */
const Daily: React.FunctionComponent<Props> = (props: Props) => {
  const onChangeTag = (event: any, value: number) => {
    if (value === ReportTabInfo.USERS) {
