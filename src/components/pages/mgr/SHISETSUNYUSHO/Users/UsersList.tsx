...
const mapStateToProps = (state: AppState): State => ({
  user: state.user,
  facilityUsers: state.SHISETSUNYUSHO.userInFacility.users
});

const mapDispatchToProps = (dispatch: Dispatch) => {
  const { userDispatch, SHISETSUNYUSHO, errorsDispatcher } = dispatches;
  const userInFacilityDispatched = SHISETSUNYUSHO.userInFacilityDispatcher(
    dispatch
  );
