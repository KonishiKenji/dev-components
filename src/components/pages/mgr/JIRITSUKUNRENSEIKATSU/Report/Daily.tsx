...
import InOutReportDaily from "@components/organisms/mgr/JIRITSUKUNRENSEIKATSU/report/InOutReportDaily";
...
const Report: React.FunctionComponent<Props> = (props: Props) => {
  const onChangeTag = (event: React.ChangeEvent<{}>, value: number) => {
    if (value === JIRITSUKUNRENSEIKATSUReportTabInfo.USERS) {
    ...
    <AdminTemplate pageName="利用実績">
      <>
        <KnowbeTabs
          ...
          selectedTab={JIRITSUKUNRENSEIKATSUReportTabInfo.DAILY}
          tabsStyle={{
            height: 35.5,
            backgroundColor: "#fff"
          }}
