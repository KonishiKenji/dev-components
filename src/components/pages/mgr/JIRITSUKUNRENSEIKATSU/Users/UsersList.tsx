...
const mapStateToProps = (state: AppState): State => ({
  user: state.user,
  facilityUsers: state.JIRITSUKUNRENSEIKATSU.userInFacility.users
});

const mapDispatchToProps = (dispatch: Dispatch) => {
  const { userDispatch, JIRITSUKUNRENSEIKATSU, errorsDispatcher } = dispatches;
  const userInFacilityDispatched = JIRITSUKUNRENSEIKATSU.userInFacilityDispatcher(
    dispatch
  );
