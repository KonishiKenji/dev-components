...
import initialValues, {
  FacilityValues
} from "@initialize/mgr/SEIKATSUKAIGO/facility/initialValues";
import validation from "@initialize/mgr/SEIKATSUKAIGO/facility/validation";
...
import BasicFields from "@components/organisms/mgr/SEIKATSUKAIGO/Facility/BasicFields";
import SubtractionItemFields from "@components/organisms/mgr/SEIKATSUKAIGO/Facility/SubtractionItemFields";
import AdditionalItemFields from "@components/organisms/mgr/SEIKATSUKAIGO/Facility/AdditionalItemFields";
...
import AdministrationScheduleFields from "@components/organisms/mgr/SEIKATSUKAIGO/Facility/AdministrationScheduleFields";
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => {
  const { cityDispatch, uiDispatch, SEIKATSUKAIGO } = dispatches;
