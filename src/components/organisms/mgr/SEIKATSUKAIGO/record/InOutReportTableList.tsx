...
import InOutReportContentsCell from "@components/organisms/mgr/SEIKATSUKAIGO/record/InOutReportContentsCell";
        ...
        .map((inOutRecord: DailyInOutRecords, index: number) => {
          return (
            <TableRow key={`table-row-${index}`} className={classes.row}>
              ...
              <InOutReportContentsCell idx={index} inOutRecord={inOutRecord} />
            </TableRow>
          );
        })
    : [];
