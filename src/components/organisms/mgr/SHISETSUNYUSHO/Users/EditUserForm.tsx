...
import initialValues, {
  UsersValues
} from "@initialize/mgr/SHISETSUNYUSHO/users/initialValues";
import validation from "@initialize/mgr/SHISETSUNYUSHO/users/validation";
...
import BasicFields from "@components/organisms/mgr/SHISETSUNYUSHO/Users/BasicFields";
import ServiceUseFields from "@components/organisms/mgr/SHISETSUNYUSHO/Users/ServiceUseFields";
import RecipientCertificateFields from "@components/organisms/mgr/SHISETSUNYUSHO/Users/RecipientCertificateFields";
      ...
      >
        {formikProps => (
          <Form>
            ...
            >
              <DeleteIcon className={this.props.classes.deleteOutline} />
              削除する
            </Button>
            <ConfirmDialog
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => {
  const { SHISETSUNYUSHO, cityDispatch, uiDispatch } = dispatches;
