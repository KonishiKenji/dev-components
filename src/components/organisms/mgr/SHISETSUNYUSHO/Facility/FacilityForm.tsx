...
import initialValues, {
  FacilityValues
} from "@initialize/mgr/SHISETSUNYUSHO/facility/initialValues";
import validation from "@initialize/mgr/SHISETSUNYUSHO/facility/validation";
...
import BasicFields from "@components/organisms/mgr/SHISETSUNYUSHO/Facility/BasicFields";
import SubtractionItemFields from "@components/organisms/mgr/SHISETSUNYUSHO/Facility/SubtractionItemFields";
import AdditionalItemFields from "@components/organisms/mgr/SHISETSUNYUSHO/Facility/AdditionalItemFields";
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => {
  const { cityDispatch, uiDispatch, SHISETSUNYUSHO } = dispatches;
