...
import initialValues, {
  FacilityValues
} from "@initialize/mgr/SHUROTEICHAKU/facility/initialValues";
import validation from "@initialize/mgr/SHUROTEICHAKU/facility/validation";
...
import BasicFields from "@components/organisms/mgr/SHUROTEICHAKU/Facility/BasicFields";
import SubtractionItemFields from "@components/organisms/mgr/SHUROTEICHAKU/Facility/SubtractionItemFields";
import AdditionalItemFields from "@components/organisms/mgr/SHUROTEICHAKU/Facility/AdditionalItemFields";
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => {
  const { cityDispatch, uiDispatch, SHUROTEICHAKU } = dispatches;
  const facilityDispatcher = SHUROTEICHAKU.facilityDispatcher(dispatch);
