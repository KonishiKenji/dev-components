...
interface OwnProps {
  ...
  contentData: IABInOutReportState;
...
const DailyOperationDiary = (props: Props): JSX.Element => {
  ...
  return (
    <>
      ...
      <Paper classes={{ root: props.classes.root }}>
        ...
        <div className={props.classes.usageSituation}>
          ...
          {(props.serviceType === FacilityType.A ||
            ...
            <UsageSituationBox
              label="施設外支援"
              value={props.operation.counts.numberOfSupportOutOfFacility}
              unit={`/${props.operation.counts.numberOfUsers}人`}
            />
          )}
          <UsageSituationBox
        ...
        <div className={props.classes.recordWrapper}>
          ...
          <RecordWorkOutOfFacility
            isEditable={props.isEditing}
            name="operation.workplace_company"
            label="施設外就労同行職員"
            defaultValue="-"
      ...
      {isOpenDialog && (
        <InOutReportModal
          countsPerStatus={props.contentData.IABSummary.countsPerStatus}
          inOutRecords={props.contentData.IABSummary.inoutRecords}
          isOpen={isOpenDialog}
          onClose={closeDialog}
          targetName=""
