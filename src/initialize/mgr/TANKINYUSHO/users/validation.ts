import { BasicErrors } from "@interfaces/mgr/TANKINYUSHO/Users/basic";
import { ServiceUseErrors } from "@interfaces/mgr/TANKINYUSHO/Users/serviceUse";
import { RecipientCertificateErrors } from "@interfaces/mgr/TANKINYUSHO/Users/recipientCertificate";
...
const serviceUseValidation = (values: UsersValues): ServiceUseErrors => {
  return {
    serviceUse: {
      ...
      payDaysAgreed: validator(
        values.serviceUse.payDaysAgreed,
        "required",
        "naturalNumberNonZero"
      ),
      businessNumberContract: validator(
