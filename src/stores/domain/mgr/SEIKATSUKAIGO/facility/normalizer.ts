...
import { OpenShortTime } from "@constants/mgr/SEIKATSUKAIGO/variables";
...
const castString = (value: number | null | undefined): string => {
...
const normalizeApiParams = (
  ...
  const facilitySEIKATSUKAIGO = result.facility_seikatsukaigo || {
    facility_type: 0,
    doctor_placement_flg: false,
    open_short_time: 0,
    nursing_supporter: 0,
    severe_disability_support_flg: 0,
    satellite_type_etc_flg: 0,
    serious_supporter_flg: false
  };
  return {
    ...
    facilityType: facilitySEIKATSUKAIGO.facility_type
      ? facilitySEIKATSUKAIGO.facility_type
      : 0,
    ...
    transferServiceType: facility.available_pickup_kind
      ...
      : "1",
    seriousSupporterFlg:
      facilitySEIKATSUKAIGO.serious_supporter_flg === INT_TRUE_FROM_API,
    doctorInstallationFlag:
      facilitySEIKATSUKAIGO.doctor_placement_flg === INT_FALSE_FROM_API,
    ...
    sundayEndTime: facility.sun_close
      ...
      : "",
    openedOrShortTimeFlag:
      facilitySEIKATSUKAIGO.open_short_time !== INT_FALSE_FROM_API,
    ...
    welfareSpecialistPlacementType: facility.welfare_condition
      ...
      : DEFAULT_RADIO_VALUE,
    fullTimeNursePlacementType: facilitySEIKATSUKAIGO.nursing_supporter
      ? facilitySEIKATSUKAIGO.nursing_supporter.toString()
      : "0",
    ...
    severeFailureSupportFlag: facilitySEIKATSUKAIGO.severe_disability_support_flg
      ? facilitySEIKATSUKAIGO.severe_disability_support_flg ===
        INT_TRUE_FROM_API
      : false,
    ...
    staffPlacementType: facility.users_vs_supporter_grade
      ? facility.users_vs_supporter_grade.toString()
      : "1"
  };
};
...
const removeUnnecessaryValue = (
  ...
  const result = {
    ...
    facility_seikatsukaigo: target.facility_seikatsukaigo
      ? { ...target.facility_seikatsukaigo }
      : undefined
  };
  ...
  if (
    result.facility.available_pickup === STRING_FALSE_FROM_API &&
    result.facility_seikatsukaigo
  ) {
    result.facility_seikatsukaigo.serious_supporter_flg = INT_FALSE_FROM_API;
  }
  return result;
};
...
export const removeNoChangeData = (
  ...
  const target: PostFacilityParams = {
    ...
    facility_seikatsukaigo: {
      ...
      satellite_type_etc_flg: undefined,
      doctor_placement_flg: undefined,
      open_short_time: undefined,
      nursing_supporter: undefined,
      severe_disability_support_flg: undefined,
      serious_supporter_flg: undefined
    }
  };
    ...
    facility_seikatsukaigo: {
      facility_type:
        state.basic.facilityType !== ""
          ...
          : 0,
      satellite_type_etc_flg: 0,
      doctor_placement_flg: state.subtractionItem.doctorInstallationFlag
        ? INT_FALSE_FROM_API
        : INT_TRUE_FROM_API,
      open_short_time: state.subtractionItem.openedOrShortTimeFlag
        ? parseInt(OpenShortTime.MORE_SIX, 10)
        : parseInt(OpenShortTime.NONE, 10),
      nursing_supporter:
        state.additionalItem.fullTimeNursePlacementType !== ""
          ? parseInt(state.additionalItem.fullTimeNursePlacementType, 10)
          : 0,
      severe_disability_support_flg: state.additionalItem
        .severeFailureSupportFlag
        ? INT_TRUE_FROM_API
        : INT_FALSE_FROM_API,
      serious_supporter_flg:
        state.basic.transferServiceFlag && state.basic.seriousSupporterFlg
          ? INT_TRUE_FROM_API
          : INT_FALSE_FROM_API
    }
  });
