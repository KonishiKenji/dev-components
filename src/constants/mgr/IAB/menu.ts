...
import OutlineWorkRecordsIcon from "@images/icons/OutlineWorkRecordsIcon";
import OpenInNew from "@material-ui/icons/OpenInNew";
import HelpOutLine from "@material-ui/icons/HelpOutline";
import { MenuItemList } from "@constants/menu";

const MENU_ITEM_LIST_IAB: MenuItemList = [
  {
    title: "利用実績",
    to: URL.REPORT,
  ...
  },
  {
    title: "作業時間",
    to: URL.WORK_RECORDS,
    icon: OutlineWorkRecordsIcon,
    checkPlanGroupLaborCharge: true
  },
  {
    title: "設定",
    to: "",
...
export default MENU_ITEM_LIST_IAB;
