...
// threadLoader.warmup(workerOptions, ["babel-loader", "ts-loader"]);
...
if (
  ...
  env.stringified["process.env"].NODE_ENV === '"staging"'
) {
  throw new Error("Production builds must not have NODE_ENV=production.");
}
            ...
            use: [
              ...
              },
              {
                ...
                options: {
                  transpileOnly: true,
                  happyPackMode: true,
                  configFile: paths.appTsDevConfig
                }
              }
            ]
          },
